package videostreaming.resources


import org.scalajs.dom.experimental.mediastream.{MediaDeviceInfo, MediaStream, MediaStreamConstraints}
...
trait MediaDevices extends EventTarget {
  ...
  def getDisplayMedia(constraints: MediaStreamConstraints): js.Promise[MediaStream] = js.native
